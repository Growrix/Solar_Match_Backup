/*
  ...
  1. New Columns
    - `quote_module` - User preference for quote type (call, written, or both)
    - `accept_calls` - Whether installers can call the user
    - `timezone` - User's timezone preference

  2. Functions
    - Add helper function for updating user settings
