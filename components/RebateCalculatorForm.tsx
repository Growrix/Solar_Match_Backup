...
import { RebateCalculator, type CalculationInputs } from '@/lib/services/rebateCalculator';
import { type RebateCalculationResult } from '@/data/rebatePrograms';
...
const RebateCalculatorForm = () => {
  ...
  const [result, setResult] = useState<RebateCalculationResult | null>(null);
  ...
  const handleCalculate = async () => {
    ...
    try {
      const calculationResult = RebateCalculator.calculate(inputs);
              ...
              <div>
                ...
                <div className="bg-yellow-500/10 border border-yellow-500/30 rounded-xl p-4 mb-4">
                  ...
                  <ul className="text-yellow-200 text-sm space-y-1">
                    {result.disclaimers.slice(0, 3).map((disclaimer, index) => (
