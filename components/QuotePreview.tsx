...
const QuotePreview: React.FC = () => {
  const handleProceedToDetailedQuote = (quoteType: 'call_visit' | 'written') => {
    // In a real implementation, this would navigate to the detailed quote form
    // For now, we'll just trigger the event to navigate to the request-quote page
    window.dispatchEvent(new CustomEvent('navigate-to-request-quote'));
  };
